...
HD_PWD='C:/Users/aduttagu/Desktop/Project Papers/A Duttagupta_Lab2/A Duttagupta_Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Dutuut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Dutuut.tcl -notrace

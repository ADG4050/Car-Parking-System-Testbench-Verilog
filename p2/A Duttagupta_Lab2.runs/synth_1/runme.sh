...
HD_PWD='C:/Users/aduttagu/Desktop/Project Papers/A Duttagupta_Lab2/A Duttagupta_Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dutuut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dutuut.tcl
